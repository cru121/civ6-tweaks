...
-----------------------------------------------
	...
	("en_US",	"LOC_TM_FEATURE_RORAIMA_EFFECT",				"Owned Jungle tiles do not reduce the appeal of adjacent plots for any Civilization that owns at least one of these tiles."	),
...
-----------------------------------------------
	...
	("en_US",	"LOC_ABILITY_TM_FEATURE_MATTERHORN_NAME",			"Matterhorn"	),
	("en_US",	"LOC_ABILITY_TM_FEATURE_MATTERHORN_DESCRIPTION",	"Ignores [ICON_Movement] Movement penalties on Hills (granted while your civilization owns the Matterhorn)."	),
	("en_US",	"LOC_ABILITY_TM_FEATURE_GRAND_MESA_NAME",			"Grand Mesa"	),
	("en_US",	"LOC_ABILITY_TM_FEATURE_GRAND_MESA_DESCRIPTION",	"Ignores [ICON_Movement] Movement penalties in Forest (granted while your civilization owns the Grand Mesa)."	),
	("en_US",	"LOC_TM_TF_MOUNTAIN_NW_FOOD",	"+1 [ICON_FOOD] Food from an adjacent mountainous Natural Wonder."	);
