...
VALUES	('MODIFIER_TM_FEATURE_KRAKATOA_ATTACH_PLAYERS',		'ModifierId',		'MODIFIER_TM_FEATURE_KRAKATOA_SCIENTIST_BOOST'	),
		-- I3 fix: TechBoost/OtherPlayers are BOOLEANS -- integer 1 reads as false, so the
		-- Eureka never fired. Use true/false (cf. base-game GREATLIBRARY_BOOST_SCIENTIST).
		('MODIFIER_TM_FEATURE_KRAKATOA_SCIENTIST_BOOST',	'GreatPersonClass',	'GREAT_PERSON_CLASS_ADMIRAL'					),
		('MODIFIER_TM_FEATURE_KRAKATOA_SCIENTIST_BOOST',	'OtherPlayers',		'false'												),
		('MODIFIER_TM_FEATURE_KRAKATOA_SCIENTIST_BOOST',	'TechBoost',		'true'												);
